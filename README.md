...
- `pair-with-claude`: collaborate with Claude in the shared project environment for reviews, research, technical debates, and isolated implementation spikes with capability-aware model and effort escalation.
